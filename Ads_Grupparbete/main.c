...
void HandleWinning(ADS winning)
{
    ...
    else if (winning.name == 6)
    {
      ...
      else if (winning.name == 7)
    {
      BrandlarmUtrymSnarast();
    }

}

void BrandlarmUtrymSnarast()
{
  char str[] = "BRANDLARM UTRYM";
  lcd.print(str);
  char str1[] = "    SNARAST!";
  lcd.print(str1);
  lcd.setCursor(0,0);
    ...
    for (int loopiloop = 0; loopiloop < 50; loopiloop++)
  {
    lcd.setCursor(0,1);
